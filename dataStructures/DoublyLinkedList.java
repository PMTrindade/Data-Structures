...
public class DoublyLinkedList<E> implements List<E> {
    ...
    public void append(DoublyLinkedList<E> list) { //Comentado
    	if(list.isEmpty()) //Se a lista recebida por argumento estiver vazia, o método não faz nada.
    		return;
    	
    	if(this.isEmpty()) //Se a lista estiver vazia, a head da lista passa a ser a head da lista recebida por argumento.
    		this.head = list.head;
    	else {
    	...
    	//A tail da lista passa a ser a tail da lista recebida por argumento, sendo o tamanho da lista aumentado adequadamente.
    	this.tail = list.tail;
